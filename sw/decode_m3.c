...
//decoding of milestone 3 - read a .mic16 file, do lossless decoding, write a .sram_d2 file
...
int main(int argc, char **argv) {
	...
	char input_filename[200], output_filename[200], quantization_choice;
	FILE *file_ptr;
	...
	if (argc<2) {
		printf("enter the input file name including the .mic16 extension: ");
